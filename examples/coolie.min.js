...
!function () {
    ...
    }, g = /^\//, w = /^(\.{1,2})\//, _ = /\/[^/]+?\/$/, m = function (e, n) {
        if (!n || g.test(n))return n;
        var t;
        for (n = "./" + n; t = n.match(w);)n = n.replace(w, ""), 2 === t[1].length && (e = e.replace(_, "/"));
        return e + n
    }, x = function (e, n) {
        return (n || i).getElementsByTagName(e)
    }, y = /[\?#].*?$/, b = /https?:\/\/[^/]*/, A = /\.js($|\?)/i, $ = function (e, n) {
        return e = e.replace(y, ""), n ? e : (_.test(e) && (e += "index"), e + (A.test(e) ? "" : ".js"))
    }, q = function (e) {
    ...
    F.config = function (e) {
        if (u = e, I = m(R, h(u.base, !0)), u.version = u.version || {}, u.host && (H = u.host), l(u.version) ? u._v = u.version : (u._v = {}, d(u.version, function (e, n) {
                u._v[H + m(I, e)] = n
            })), O) {
            var n = J.url = $(H + m(I, O));
            J._defined = !1, P[n] = J
        ...
        return K ? F : (K = !0, r = t(), e && (J.url = $(H + m(I, e)), P[J.url] = J), J.url ? (L(J.url), p.group("coolie modules"), F) : F)
    }, F.callback = function (e) {
        return J._executed && f(e) ? (e.call(F, J.exports), F) : (f(e) && c.push(e), F)
    };
    ...
    N && L(z + "?" + t(), !0), window.coolie = F, window.coolie.modules = U, window.coolie.configs = u, window.coolie.each = d, window.define = on, window.define.amd = {}, window.define.cmd = {}
}();