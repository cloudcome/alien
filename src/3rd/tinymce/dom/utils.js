...
define(function (require, exports, module) {
    ...
    var Sizzle = require("./tinymce/dom/Sizzle");
    var $ = require("./tinymce/dom/DomQuery");
    var Styles = require("./tinymce/html/Styles");
    var EventUtils = require("./tinymce/dom/EventUtils");
    var TreeWalker = require("./tinymce/dom/TreeWalker");
    var Range = require("./tinymce/dom/Range");
    var Entities = require("./tinymce/html/Entities");
    var Env = require("./tinymce/Env");
    var Tools = require("./tinymce/util/Tools");
    var StyleSheetLoader = require("./tinymce/dom/StyleSheetLoader");
    // Shorten names
